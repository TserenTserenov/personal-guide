...
Спрось пилота **только если статус неоднозначен** (например, задание имеет частичный ответ — `partial` vs `done`?). Одно сообщение, два варианта: «Считаем done или partial? (one word)».
